      ...
      <div className="px-6 h-16 flex items-center justify-between gap-6">
        ...
        <div className="hidden md:flex items-center gap-2 flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <input
              type="text"
              placeholder="Search submissions, families, IOCs…"
        ...
        <div className="flex items-center gap-2">
          {right}
          <button className="relative inline-flex items-center justify-center w-9 h-9 border border-ink/10 hover:border-ink transition-colors">
