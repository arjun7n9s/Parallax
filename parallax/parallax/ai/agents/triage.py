...
When producing hypotheses, you MUST:
  ...
  - Provide an irt_label field on every item: a single clean sentence that summarizes the conclusion for a non-technical reader
...
Version: {apk_metadata.get('version_name', 'Unknown')} (code {apk_metadata.get('version_code', 'Unknown')})
File Size: {apk_metadata.get('file_size', 0)} bytes
Min SDK: {apk_metadata.get('min_sdk', 'Unknown')} | Target SDK: {apk_metadata.get('target_sdk', 'Unknown')}
